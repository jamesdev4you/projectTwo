...
int main(){
    ...
    while(true) {
        ...
        if(choice == 1){
            ...
            std::cin >> title;
            std::cout<< "What is the Song artist?\n";
            std::cin >> artist;
            std::cout << "What is the Song duration?\n"; 
            std::cin >> time;
            
            player.addSong(Song(title, artist, time));
        }
        else if(choice == 2){
            std::string title, artist, sponsor, time, episode;
            ...
            std::cin >> time;
            std::cout << "What is the Podcast episde number?\n";
            std::cin >> episode;
